...
import sirstotes.pucks_building_additions.GateBlock;
...
public class PaneBlockMixin {
    ...
    public boolean includePaneDoors (boolean original, BlockState state, boolean sideSolidFullSquare) {
        return original || state.getBlock() instanceof PaneDoorBlock || state.getBlock() instanceof GateBlock;//TODO: Only connect to side of pane doors.
    }
}
